...
func (a *App) renderMobileV2(w http.ResponseWriter, token, targetDir, target, mode, msg, pageErr string) {
	...
	onlyBooks := mobileText(lang, "Поддерживаются только файлы книг", "Only book files are supported", "Seuls les fichiers de livres sont pris en charge", "Es werden nur Buchdateien unterstützt")
